package com.asbollapragada.firebase_store;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                // to select an image from device //
        ...
        dref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot dataSnapshot:snapshot.getChildren()){
                    ...
                    Glide.with(MainActivity.this).load(upload.getLink()).placeholder(R.drawable.ic_launcher_background).error(R.drawable.ic_launcher_foreground).override(300, 300).centerCrop().into(display);
                }
            }
